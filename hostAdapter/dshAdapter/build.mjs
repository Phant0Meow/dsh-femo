...
const clientOptions = {
  ...
  platform: 'browser',
  format: 'cjs',
  // 必须显式 automatic：femoGen/src/faIcons.jsx（.jsx）不在本 tsconfig 的
  // react-jsx 覆盖范围内，默认 transform 会编出裸 React.createElement，
  // 运行时抛 "React is not defined"（2026-09-14 FaIcon 崩溃修复）。
  jsx: 'automatic',
