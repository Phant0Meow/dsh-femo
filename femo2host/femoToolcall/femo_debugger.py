...
用法：
  python femo2host/femoToolcall/femo_debugger.py run femoExamples/goblin-mini.femo
  python femo2host/femoToolcall/femo_debugger.py run a.femo --runs 3 --seed 42
  python femo2host/femoToolcall/femo_debugger.py run a.femo --set player_choice=拒绝 --set @hero=@knight
  python femo2host/femoToolcall/femo_debugger.py run a.femo --module BattleRound   # 模块单测
  python femo2host/femoToolcall/femo_debugger.py run a.femo --module Outer.Inner   # 嵌套模块（点路径）
  python femo2host/femoToolcall/femo_debugger.py run a.femo --assign-prob 0.7      # 概率赋值
  python femo2host/femoToolcall/femo_debugger.py list a.femo / parse a.femo / coverage a.femo
